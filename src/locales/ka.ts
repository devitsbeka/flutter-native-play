...
export const ka = {
  ...
  extra: {
    ...
    completed: "{done}/{total} შესრულებულია",
    quickStats: "სწრაფი სტატისტიკა",
    playedToday: "დღეს ითამაშე",
    ...
    notifStreak: "სერია",
    notifLevelUp: "დონის ამაღლება",
    notifAchievement: "მიღწევა",
    notifTriviaLiked: "მოწონება",
    notifTriviaSaved: "შენახვა",
    notifTriviaPlayed: "ითამაშა",
