...
export const en: KaTranslations = {
  ...
  extra: {
    ...
    newButton: "NEW",
    day: "Day {count}",
    streakMilestoneReward: "Milestone Reward",
    milestoneXpBonus: "{percent}% XP Bonus",
    milestoneXpBonusGift: "{percent}% XP Bonus + Gift",
    milestoneDoubleXp: "2x XP + Exclusive Badge",
    milestoneUnlocked: "Unlocked!",
    milestoneLocked: "Play {count} more days to unlock",
    ...
    weekdaySat: "Sat",
    weekdaySun: "Sun",
    streakGiftReward: "5-Day Streak Reward",
    today: "Today",
