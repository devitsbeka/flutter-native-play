...
export const en: KaTranslations = {
  ...
  discover: {
    ...
    promoCtaTrialDays: "Try {days} days free",
    promoNote: "{price} / {period}, cancel anytime",
    promoNoteTrial: "{days} days free, then {price} / {period}",
    free: "Free",
    premium: "Premium",
    all: "All",
    favorites: "Favorites",
  ...
  missions: {
    ...
    infoStreakLead: "Complete at least one mission a day to keep the streak; each milestone pays coins once",
    ...
    achStreak3Desc: "Keep your streak for 3 days in a row",
    achStreak7: "Weekly Hero",
    achStreak7Desc: "Keep your streak for 7 days in a row",
    achStreak14: "Two-Week Champion",
    achStreak14Desc: "Keep your streak for 14 days in a row",
    achStreak30: "Monthly Legend",
    achStreak30Desc: "Keep your streak for 30 days in a row",
  ...
  legal: {
    ...
    photosData: "Photographs:",
    photosDataDesc: "If you create an avatar from a photo, that photo is uploaded and sent to an AI image provider to generate the avatar. We use it only to produce your avatar; we do not show it to other players and we do not sell it. Deleting the avatar deletes the photo.",
    userContentData: "Content You Create:",
    userContentDataDesc: "Quizzes, collections and room names you make in the app, which other players can see",
    locationData: "Approximate Location:",
    locationDataDesc: "Your country, determined once from your IP address, to set your default language and region. We do not collect precise location.",
    gameData: "Game Data:",
    ...
    withProviders: "With the service providers listed above, only so they can perform their function",
    dataRetention: "Data Retention",
    dataRetentionText: "Your data is stored as long as your account is active. A photo uploaded for an avatar is kept only as long as that avatar. After a deletion request, all data — photos and avatars included — will be deleted within 30 days.",
    ...
    thirdPartyFalAi: "fal.ai: AI image generation — the photo you use for an avatar is sent here to produce it",
  ...
  iap: {
    ...
    subscriptionOnAnotherAccount: "This subscription is already active on another account. Tap Restore Purchase to move it across.",
    ...
    noneBody: "This Apple ID hasn't bought anything here yet.",
  ...
  playLimit: {
    ...
    roomsLockedTitle: "Go PRO and invite friends to play",
    roomsLockedBody: "Create game rooms and trivias",
    giveUp: "Give up",
  ...
  missionPool: {
    ...
    play_oneTitle: "Game of the day",
    play_oneDesc: "Play one game",
  ...
  gameTypes: {
    ...
    wordsTitle: "Words",
    wordsDesc: "Spell words from a wheel of letters to fill a crossword. Solo or with a friend.",
  },
  // Team Battle (docs/GAME_TYPES_DESIGN.md §2)
  teamBattle: {
    title: "Trivia Battle",
    entryHint: "Two teams, a board of priced categories, one player in the spotlight at a time.",
    ...
    needEqualTeams: "Teams must be equal, and everyone needs a side",
    leave: "Leave room",
    ...
    reactionGenius: "Genius",
    callOut: "Pick an answer!",
    iconSendFailed: "Couldn't send",
    iconsForYou: "Sent to you",
    startTimeout: "Loading questions took too long — check your connection and try again",
    ...
    rpsPickOne: "Pick one",
    rpsCaptainsHint: "The captains are throwing — watch the duel",
    ...
    points: "{n} pts",
    yourTurn: "Your turn!",
    watching: "{name} is playing",
    correct: "Correct!",
    wrong: "Wrong",
    answersSoFar: "answers so far",
    tileWorth: "Worth {n} points",
    superVoteTitle: "Vote your champion",
    superVoteSubtitle: "A tie! One player from each team plays a blitz for the win.",
  ...
  king: {
    ...
    king: "The King",
    firstTo6: "first to 6",
    introTitle: "Very hard questions. No prior knowledge needed.",
    introBody: "One minute to think — with no options on screen. Then 10 seconds to commit. Crack it and you score; miss and the King does. First to 6 wins.",
    start: "Challenge the King",
    questionNo: "Question {n}",
    thinkHint: "No options yet. Think.",
    haveIt: "I have it!",
    teamLabel: "Team",
    ...
    cracked: "Cracked!",
    kingScores: "The King scores",
    teamPickedLabel: "Your team picked",
    yourPickLabel: "You picked",
    nothingLocked: "Nothing locked — time ran out",
    answerLabel: "The answer",
    logicLabel: "The logic",
    reportQuestion: "Report this question",
    reportThanks: "Reported — thank you",
    plusPoint: "+ 1 point to",
    pointToKing: "the King",
    pointToTeam: "{name}",
    next: "Next question",
    youWon: "You beat the King!",
    kingWon: "The King takes this one",
    playAgain: "Play again",
  ...
  lobby: {
    ...
    uPlayersTab: "Players",
    uJoinedNote: "joined",
    uInvitedNote: "invited",
    uLeftNote: "left",
    uQuestionsPerRound: "Questions per round",
    summaryChange: "Change",
    summaryRematchTitle: "Ready for a rematch?",
    summaryRematchHint: "Everyone at the table is asked first. Whoever declines leaves the room.",
    summaryAskTable: "Ask for rematch",
    summaryFree: "Free to play",
    summaryStake: "Prizes",
    ...
    uRoundsSelected: "{count} rounds",
    invite: "Invite",
    winnerTakes: "Winner earns",
    ...
    autoRounds: "Every player plays twice",
    ...
    rulesHeading: "Rules",
    timeHeading: "Time",
    rulesClassic: "Everyone in the room answers the same question at the same moment. A correct answer scores, and the sooner it lands the more it is worth — with a bonus for whoever gets there first. The highest total after the last question takes the room.",
    timeClassic: "15 seconds a question. A question left unanswered scores nothing, so answer before the bar runs out.",
    rulesKing: "Hard logic questions, the whole couch against the King. Crack one and the point is yours; let it past and it is the King's. First to 6 wins the crown.",
    timeKing: "One minute to think about each puzzle — these are questions to work out, not to recall.",
    timeBattle: "Every player plays twice, so the match runs as long as the teams are big. Every turn is answered against the clock.",
    rulesWords: "Spell the words that fill the board from the letters on the wheel. Every word you find is one your friend no longer has to — fill the board and the level is done.",
    timeWords: "No clock at all. Take as long as you like; a hint costs coins, never seconds.",
    inviteToGame: "Invite to this game",
    invitedState: "Invited",
    sendLink: "Send the link",
    removeSeat: "Remove",
    moveTo: "Move to {team}",
    switchTeam: "Switch team",
    seatChooserTitle: "Who takes this seat?",
    ...
    captainInfoBody: "The captain is the team's leader — if the score ends tied, only the captains face each other in the deciding round.",
  },
  ...
  words: {
    ...
    solvedBy: "Solved by {pct}% of players",
    bonusWordsFound: "{n} bonus words found",
    continue: "Continue",
    ...
    collect: "Collect",
    prizeCoins: "{n} coins",
    prizeHint: "1 free hint",
    prizeHints: "{n} free hints",
    youWon: "You won {prize}",
    scrapbook: "Scrapbook",
    scrapbookTitle: "Build your own scrapbook",
    sceneUnlocked: "{scene} added to your scrapbook",
    nextScene: "Next scene",
    viewScrapbook: "View scrapbook",
    unlockLevels: "Levels {from}–{to}",
    menu: "Menu",
    restartLevel: "Restart level",
    leaveGame: "Leave game",
    resetProgress: "Reset all progress",
    resetConfirm: "This clears your levels, coins and scrapbook on this device.",
    coinsTitle: "Coins",
    coinsInfo: "Solve a level for +{level} coins. Every {every} bonus words pay +{bonus}. A hint costs {hint}.",
    gotIt: "Got it",
    inviteFriend: "Invite a friend",
    invite: "Invite",
    invited: "Invited",
    ...
    playTogetherDesc: "Solve the same board with one friend, live.",
    friendLeft: "{name} left",
    signInToInvite: "Sign in to invite a friend",
    hostContinues: "Waiting for {name} to continue…",
    foundBy: "{name} found {word}",
    online: "Online",
    offline: "Offline",
    roomGone: "This game is no longer available.",
  ...
  extra: {
    ...
    landingJoinSubtitle: "Join thousands of players worldwide",
    ...
    railMyTriviasDesc: "your quizzes",
    railPro: "Go Pro",
    railProDesc: "unlock everything",
    railOffers: "Daily offers",
    railOffersDesc: "ends soon",
    randomOption: "Random",
    ...
    modeGuessTitle: "Guess Game",
    modeQuickTitle: "Quick Game",
    modeLibraryTitle: "Classic",
    modeKingTitle: "vs. King",
    modeBattleTitle: "Team Battle",
    modeGuessDesc: "Guess the logo, the flag, the city and more.",
    guessPickTitle: "What will you guess?",
    modeQuickDesc: "Play classic trivia from hundreds of categories.",
    modeWordsDesc: "Link letters and build words.",
    createBtn: "Create",
    inviteBtn: "Invite",
    ...
    pingHostBtn: "Invite the host",
    pingHostSent: "The host has been notified! 🔔",
    pingHostNotifTitle: "{name}: Let's play!",
    pingHostNotifBody: "They are waiting for you in the room",
    ...
    notifRequestAlreadyAnswered: "That request was already answered.",
    rematchAskCta: "Ask for a rematch",
    rematchAskSent: "Rematch request sent",
    rematchRequestTitle: "Rematch?",
    rematchRequestBody: "{name} wants a rematch",
    rematchNewGameBody: "{name} is starting a new game",
    ...
    rematchWonTitle: "{name} won!",
    rematchWaiting: "Waiting…",
    duelTitle: "Versus Trivia King",
    duelOpponent: "Trivia King",
    duelWin: "You beat Trivia King!",
    duelLose: "Trivia King takes this one",
    duelDraw: "A draw — well played!",
    duelBackToGuess: "Back to guess games",
    duelIntroHint: "Score more than Trivia King to win 100 coins.",
    duelRulesHint: "Score more than Trivia King to win 100 coins.",
    roomPreviewEyebrow: "Room preview",
    rematchWaitHint: "Everyone at the table has been asked. Whoever declines leaves the room.",
    ...
    rematchRemovedTitle: "Removed from the rematch",
    rematchRemovedBody: "{name} started the new match before you answered, so your seat was given up. You can ask to join again.",
    leaveRoundTitle: "Leave the round?",
    leaveRoundBody: "The others play on without you. Leaving costs nothing.",
    leaveRoundConfirm: "Leave",
    notifPlay: "Play",
    notifView: "View",
    notifOpen: "Open",
    // Notifications page
    ...
    joinDeclinedBody: "The host said no this time",
    joinAsked: "Asked to join — waiting for the host",
    joinAskFailed: "Could not send the request",
    joinBlocked: "You can't join this host's rooms",
    joinRoomFull: "That room is full",
    settleDailyCap: "Today's reward limit is reached — come back tomorrow",
    settleNoBalance: "Nothing to lose — every game is free",
    publicEmptyTitle: "No public rooms yet",
    ...
    joinRequestMyTeam: "My team",
    joinRequestOpponent: "Opponent",
    ...
    refreshBtn: "Restart",
    teamSizeLabel: "Number of players",
    spinCategoryBtn: "New category ({count} left)",
    ...
    proSeatsSend: "Gift",
    proSeatsSentBadge: "PRO Sent",
    proSeatsNoFriends: "Add a friend first, then you can give them PRO.",
    proSeatsAllHavePro: "Everyone on your friends list already has PRO.",
    ...
    inviteFriendSubtitle: "wants to be friends on MyTrivia",
    inviteFriendTagline: "Accept and play quizzes together",
    inviteAcceptFriend: "Accept",
    ...
    inviteRoomLive: "Live",
    inviteRoomFinished: "Finished",
    inviteRoomOpenedAgo: "Opened {ago}",
    inviteRoomPlayedAgo: "Played {ago}",
    inviteRoomOverBody: "This game is over, but you can still add the players.",
    inviteLoadFailed: "We could not reach the invitation. Check your connection and try again.",
    ...
    playTriviaBattle: "Play Trivia Battle",
    playCreateRoomInvite: "Create a room and invite",
    ...
    uploadBtn: "Upload",
    monthAwardTitle: "#{rank} on the {where} leaderboard, {month}",
    ...
    inviteModalBody: "Invites you to a game",
    ...
    howToPlayPrompt: "What do you feel like playing?",
    publishBtn: "Publish",
    ...
    tvSheetPitch: "Play together — everyone answers from their own phone.",
    roomInvitedYou: "You're invited",
    ...
    streakDayOne: "day",
    streakDayMany: "days",
    streakCoinsReward: "{count} coins",
    streakWeekChest: "Week reward",
    streakNotYet: "{count} days to go",
    streakKeepRule: "Complete at least one mission a day to keep your streak",
    streakDayMissions: "Day's missions",
    streakMilestonesTitle: "Streak rewards",
    ...
    voteUnit: "votes",
    voteThanksKnew: "Thanks! You knew it.",
    voteThanksDidntKnow: "Thanks! Now you know.",
    ...
    quizStakeWon: "You earned",
    quizStakeLost: "No coins lost — try again!",
    ...
    mpOnlyHostStarts: "Only the host can start the round",
    mpReopenRoom: "Reopen the room and try again",
  ...
  paywall: {
    ...
    planAnnual: "Annual",
    planAnnualBlurb: "A year of PRO + 5 friends",
    planTrialBlurbOne: "Try 1 day free",
    planTrialBlurb: "Try {days} days free",
    ...
    planFriendsBlurb: "Full access + 5 friends",
    perMonth: "{price} / mo",
    benefitsLead: "Activate PRO and get:",
    benefitPlayTitle: "Unlimited play",
    benefitPlayBlurb: "No daily limit",
    benefitInviteTitle: "Share PRO",
    benefitInviteBlurbOne: "Pass PRO to 1 friend",
    benefitInviteBlurb: "Pass PRO to {count} friends",
    benefitNoAdsTitle: "No ads",
    benefitNoAdsBlurb: "Nothing gets in your way",
    benefitLevelsTitle: "Every level",
    benefitLevelsBlurb: "All categories unlocked",
    benefitXpTitle: "Double XP",
    benefitXpBlurb: "Climb the board twice as fast",
    benefitShopTitle: "Shop rewards",
    benefitShopBlurb: "Daily coins and more spins",
    ctaTrial: "Try PRO for free",
    ctaSubscribe: "Get PRO",
    trialBadge: "{days} days free",
    ctaTrialPrice: "Try it for {price}",
    ctaPrice: "Continue — {price}",
    working: "Just a moment…",
    footnote: "{price} / {period}, cancel anytime",
    footnoteTrial: "First {days} days free, then {price} / {period} — cancel anytime",
    period_annual: "year",
  ...
  homeV3: {
    ...
    pathsTitle: "Paths",
    pathsNew: "NEW",
    pathsSubtitle: "Play whole worlds of trivia as one guided path, level by level",
    categoriesUnit: "categories",
    levelsUnit: "levels",
    view: "View",
    startWithTitle: "Categories to Start With",
    viewCollection: "View Collection",
    proHeroTitle: "The great power of PRO",
    proHeroSubtitle: "Here's what you're missing",
    proHeroCta: "View PRO offers",
    proBenefitsTitle: "All PRO Benefits",
    viewAllTitle: "View all categories",
    viewAllSubtitle: "Over {count} categories of trivia",
    promoCta: "Get PRO",
    tabHome: "Home",
    tabExplore: "Explore",
    tabBattle: "Battle",
    ...
    path_classic_tag: "General knowledge",
    path_classic_title: "The Classics",
    path_classic_desc: "The **essentials** of trivia: history, geography, science and sport, from the **first civilisations** to the modern day. Through **kings**, **capitals** and **discoveries**, every level asks what you really remember from school and everything you have picked up since.",
    path_fun_tag: "Just for fun",
    path_fun_title: "The Fun Side",
    path_fun_desc: "Everything that is **not homework**: movies, music, memes, animals and fun facts. Through **pop culture**, **video games** and **internet legends**, the questions stay light and the competition does not.",
    path_educational_tag: "School & science",
    path_educational_title: "The Learning Curve",
    path_educational_desc: "The **sciences** and the **subjects** worth knowing: mathematics, physics, chemistry, space and the mind. Through **atoms**, **planets** and **algorithms**, each level leaves you a little sharper than the last.",
    path_pictures_tag: "Guess the picture",
    path_pictures_title: "The Picture Round",
    path_pictures_desc: "**Look**, then answer: celebrities, cities, logos, flags, movies and athletes, shown as **pictures** rather than words. Through **famous faces**, **skylines** and **badges**, it is the fastest round in the app.",
    row_classic_title: "Classic Trivia",
    row_classic_subtitle: "History, geography, science and the rest of the canon",
    row_fun_title: "Just for Fun",
    row_fun_subtitle: "Memes, movies, music and everything in between",
    row_educational_title: "Learn Something",
  ...
  playRewards: {
    ...
    winEarns: "Win {amount}",
    prizesLabel: "Prizes",
    prizeLadder: "1st {first} · 2nd {second} · 3rd {third}",
    prizeWinnerOnly: "1st {first}",
    winnerEarns: "Winner earns",
    noCoinsAtRisk: "Nothing to lose — every game is free",
    rematchHint: "Everyone at the table is asked first. Whoever declines leaves the room.",
    rematchWaitHint: "Everyone at the table has been asked. Whoever declines leaves the room.",
    leaveRoundBody: "The others play on without you. Leaving costs nothing.",
    duelIntroHint: "Score more than Trivia King to win {amount} coins.",
    duelDraw: "A draw — well played!",
    duelLoseNoCost: "No coins lost — try again!",
    youEarned: "You earned",
    placePrize: "{place} place",
    newCategory: "New category ({count} left)",
    levelBonusTitle: "Level bonus!",
    levelBonusBody: "Two levels cleared — here's a reward.",
    collect: "Collect",
    chestFixed: "Daily chest: {amount} coins",
    paywallShopBlurb: "Daily coins and bonus rewards",
    coinsDescSmall: "A handy top-up for power-ups",
    coinsDescMedium: "Plenty for power-ups and extras",
    dailyCapReached: "Today's reward limit is reached — come back tomorrow",
  },
};
