...
export const en: KaTranslations = {
  ...
  paywall: {
    title: "Get everything MyTrivia has",
    planAnnual: "Annual",
    planAnnualBlurb: "Best value, billed yearly",
    planSolo: "PRO",
    planSoloBlurb: "1 friend invite",
    planFamily: "Family PRO",
    planFamilyBlurb: "Invite up to 5 friends",
    planWeekly: "Weekly",
    planWeeklyBlurb: "Pay as you go",
    freeTrialSuffix: "(Free Trial)",
    perMonth: "{price}/mo",
    popularSave: "Popular · Save {amount}",
    benefitsLead: "Unlocking PRO gets you…",
    benefitPlayTitle: "Unlimited play",
    benefitPlayBlurb: "No daily limit, ever",
    benefitLevelsTitle: "Every level",
    benefitLevelsBlurb: "All categories unlocked",
    benefitNoAdsTitle: "No ads",
    benefitNoAdsBlurb: "Nothing between you and the game",
    benefitXpTitle: "Double XP",
    benefitXpBlurb: "Climb the board twice as fast",
    benefitShopTitle: "Shop rewards",
    benefitShopBlurb: "Daily coins and bigger spins",
    ctaTrial: "Try {days} days for free",
    ctaSubscribe: "Subscribe",
    working: "Just a moment…",
    footnoteTrial: "{days} days free, then {price}/{period}, cancel anytime",
    footnote: "{price}/{period}, cancel anytime",
    period_annual: "year",
    period_solo_monthly: "month",
    period_family_monthly: "month",
    period_weekly: "week",
    terms: "Terms of Use",
