...
export const en: KaTranslations = {
  ...
  lobby: {
    ...
    summaryHint: "Last chance to change the rounds and questions — once the match starts, they are set. Visibility can change any time.",
    summaryTitle: "Ready to start?",
  ...
  extra: {
    ...
    modeGuessDesc: "Guess the logo, the flag, the city — one picture, four answers.",
    guessPickTitle: "What will you guess?",
    modeQuickDesc: "Play classic trivia from hundreds of categories.",
    modeWordsDesc: "Spell words from letters to fill a board. Solo or with a friend.",
    createBtn: "Create",
    inviteBtn: "Invite",
