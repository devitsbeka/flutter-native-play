...
export const en: KaTranslations = {
  ...
  extra: {
    ...
    leaveRoundBody: "Your stake stays in the pot and the others play on without you.",
    ...
    settleDailyCap: "Today's coin limit is reached — this win paid nothing",
    settleNoBalance: "No coins to stake — nothing moved",
    ...
    spinCategoryBtn: "Spin category ({count} left)",
    ...
    quizStakeWon: "stake won",
    quizStakeLost: "stake lost",
