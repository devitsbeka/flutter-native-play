...
export const en: KaTranslations = {
  ...
  gameTypes: {
    ...
    kingDesc: "Face the King as a team — the captain locks your answers",
  },
  ...
  teamBattle: {
    ...
    invitedPendingCount: "{n} invited — waiting to join",
    duration: "Match length",
    roundsN: "{n} rounds",
    turnTally: "{correct} of {total} correct",
    turnFor: "for {team}",
    lastRight: "✓ +{points}",
    lastWrong: "✗ +0",
    teamA: "Team A",
  ...
  kingTeam: {
    title: "Versus King",
    entryHint: "Gather your friends and face the King together — vote on every answer, but only the captain's call counts.",
    createRoom: "Create a room",
    ...
    invite: "Invite",
    linkCopied: "Invite link copied",
    lobbyHint: "6 rounds, 5 questions each. The team votes, the captain decides. Win 4 rounds to dethrone the King!",
    playerCount: "{n} / {max} players",
    invitedPending: "Invited",
    needTwoPlayers: "You need at least 2 players to face the King",
    waitingHost: "Waiting for the host to start…",
    starting: "Preparing the match…",
    start: "Start the match",
    createFailed: "Could not create the room",
    roomNotFound: "Room not found",
    matchInProgress: "This match is already running",
    roomFull: "The room is full",
    joinFailed: "Could not join the room",
    notEnoughQuestions: "Not enough questions in your language",
    teamLabel: "Team",
    kingLabel: "King",
    you: "you",
    voteTitle: "Choose your captain",
    voteSubtitle: "30 seconds — the most-voted player leads the team",
    voteWaiting: "Waiting for everyone's vote…",
    roundOf: "Round {n} / {total}",
    youAreCaptain: "You are the captain — the team's answer is yours to lock",
    captainIs: "Captain: {name}",
    teamGotIt: "The team got it!",
    teamMissedIt: "The King takes this one",
    noAnswer: "No answer — the King takes it",
    lockFinal: "Lock as team answer",
    captainHint: "You see everyone's picks. Tap an answer, then lock it in.",
    pickWaiting: "Vote in — the captain is deciding…",
    pickHint: "Tap the answer you believe in — the captain sees your pick",
    roundWon: "Round won!",
    roundLost: "The King takes the round",
    roundTally: "{n} of 5 answers were right",
    blitzTitle: "Blitz!",
    blitzSubtitle: "3:3 — it all comes down to {name}",
    captainPlaying: "Your captain is playing the blitz…",
    teamWins: "You dethroned the King!",
    kingWins: "The King stays crowned",
    rewardLine: "+200 coins for every player",
  },
  king: {
    title: "MyTrivia King",
    you: "You",
