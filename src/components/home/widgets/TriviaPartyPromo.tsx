  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          background: "linear-gradient(135deg, hsl(var(--primary) / 0.3) 0%, hsl(280, 70%, 60% / 0.2) 100%)",
        }}
      />
      
      {/* Decorative blobs */}
      <div className="absolute -right-4 -top-4 w-16 h-16 rounded-full bg-primary/10 blur-xl" />
      <div className="absolute -left-4 -bottom-4 w-20 h-20 rounded-full bg-primary/5 blur-2xl" />
