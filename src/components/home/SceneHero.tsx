    ...
    <div className="relative w-full h-full pointer-events-none">
      ...
      >
        ...
        >
          ...
          <p
            className="absolute left-[44px] top-[2.77px] -translate-x-1/2 text-[35px] font-bold leading-[52.5px] tracking-[-1.75px] text-white whitespace-nowrap"
            style={{
          ...
          <p className="absolute left-[44.9px] top-[46.66px] -translate-x-1/2 text-[9.85px] font-bold leading-[14.78px] text-[rgba(255,255,255,0.7)] whitespace-nowrap">
            {t("modals.levelLabel")}
          </p>
        </button>
