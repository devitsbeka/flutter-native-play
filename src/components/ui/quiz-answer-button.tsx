  ...
  ({ state = "default", label = "A", text, onClick, disabled = false, showLabel = true, className }, ref) => {
    ...
    return (
      ...
      >
        ...
        {/* Main Face */}
        <div
          className="relative flex items-center h-full min-h-[60px] [@media(max-height:700px)]:min-h-[52px] py-2.5 [@media(max-height:700px)]:py-2 rounded-2xl transition-transform duration-100"
          style={{
