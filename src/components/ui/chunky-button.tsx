...
const variantStyles = {
  ...
  gold: {
    face: "bg-gradient-to-b from-[#FBBF24] via-[#F59E0B] to-[#D97706]",
    textColor: "text-white",
    depth: "#B45309",
    border: "#D97706",
  ...
  silver: {
    face: "bg-gradient-to-b from-[#D1D5DB] via-[#9CA3AF] to-[#6B7280]",
    textColor: "text-white",
    depth: "#4B5563",
    border: "#6B7280",
    ...
    shine: "from-white/45 via-white/15 to-transparent",
    particle: "bg-white/50",
  },
  bronze: {
    face: "bg-gradient-to-b from-[#CD7F32] via-[#A0522D] to-[#8B4513]",
    textColor: "text-white",
    depth: "#6B3410",
    border: "#7B3F1A",
    innerBorder: "rgba(255,255,255,0.3)",
    ...
    shine: "from-white/35 via-white/12 to-transparent",
    particle: "bg-white/50",
  },
};
    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          "overflow-visible origin-center select-none",
          styles.face,
          styles.textColor,
          sizeStyles[size],
          className
