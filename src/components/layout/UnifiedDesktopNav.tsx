...
export function UnifiedDesktopNav({
  ...
  return (
    <nav className="hidden md:flex flex-col w-[72px] lg:w-[220px] min-w-[72px] lg:min-w-[220px] h-screen sticky top-0 border-r border-border/30 bg-white pt-6 pb-4 transition-all duration-200 z-40">
      {/* Logo */}
