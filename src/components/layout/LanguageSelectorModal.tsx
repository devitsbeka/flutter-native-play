      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-0 top-0 z-[101] flex justify-center pt-16 px-4 pointer-events-none"
          >
            <div className="w-full max-w-lg bg-card rounded-3xl shadow-2xl border border-border/50 overflow-hidden max-h-[75vh] flex flex-col pointer-events-auto">
              {/* Header */}
