...
const CONTEXT_KEYWORD_MAP: Record<string, string[]> = {
  ...
  'გამარჯვებ': ['victory', 'trophy', 'medal', 'crown'],
  'დამარცხებ': ['defeat', 'broken', 'surrender'],
  'ლაშქრობ': ['army', 'soldier', 'march', 'war'],
  'შეტაკებ': ['battle', 'clash', 'conflict'],
  'დაპყრობ': ['conquest', 'empire', 'crown'],
  
  // Historical figures - Royalty
  'მეფ': ['king', 'crown', 'throne', 'scepter', 'royal'],
  'დედოფ': ['queen', 'crown', 'tiara', 'royal'],
  'თამარ': ['queen', 'crown', 'georgia', 'royal'],
  'დავით': ['king', 'crown', 'church', 'builder'],
  'აღმაშენებ': ['builder', 'church', 'construction', 'king'],
  'გიორგი': ['king', 'saint', 'cross', 'georgia'],
  'ბაგრატ': ['king', 'crown', 'dynasty'],
  'სამეფო': ['kingdom', 'crown', 'castle', 'royal'],
  'იმპერია': ['empire', 'crown', 'globe', 'world'],
  'ტახტ': ['throne', 'crown', 'king', 'royal'],
  'გვირგვინ': ['crown', 'king', 'royal', 'jewel'],
