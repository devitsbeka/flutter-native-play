...
export function AnswerChoiceAvatars({
  ...
  return (
    <motion.div
      ...
      // The -50% lift must ride inside framer's transform: the animated
      // scale writes an inline transform that overrides any Tailwind
      // translate class, which used to leave the badge hanging below centre.
      style={placement === "inline" ? { y: "-50%" } : undefined}
      className={cn(
