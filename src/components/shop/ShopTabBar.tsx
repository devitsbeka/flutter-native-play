        ...
        {TABS.map((tab) => {
          ...
          return (
            <motion.button
              ...
              style={{
                background: isActive ? tab.gradient : "hsl(var(--muted))",
            ...
            >
              ...
              {isActive && (
                <motion.div
                  ...
                  style={{ background: tab.gradient, filter: "blur(12px)", opacity: 0.5 }}
                />
              )}
            </motion.button>
          );
