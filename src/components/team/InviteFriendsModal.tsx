...
const SmsIcon = () => (
  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center shadow-md" style={{ boxShadow: "0 3px 0 hsl(142 76% 30%)" }}>
    <Phone className="w-5 h-5 text-white" />
  </div>
);

const MessengerIcon = () => (
  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 flex items-center justify-center shadow-md" style={{ boxShadow: "0 3px 0 hsl(280 70% 35%)" }}>
...
const WhatsAppIcon = () => (
  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center shadow-md" style={{ boxShadow: "0 3px 0 hsl(142 76% 28%)" }}>
    <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
...
const XTwitterIcon = () => (
  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-gray-800 to-black flex items-center justify-center shadow-md" style={{ boxShadow: "0 3px 0 hsl(0 0% 15%)" }}>
...
const EmailIcon = () => (
  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center shadow-md" style={{ boxShadow: "0 3px 0 hsl(0 70% 35%)" }}>
          ...
          <div className="flex-1 overflow-y-auto p-4">
            ...
            <div className="flex items-center justify-center gap-6">
              {shareOptions.map((option, index) => (
                ...
                >
                  <option.icon />
                  <span className="text-[9px] font-medium text-muted-foreground">{option.label}</span>
                </motion.button>
              ))}
            </div>
          </div>
