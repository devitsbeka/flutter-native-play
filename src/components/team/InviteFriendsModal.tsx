...
const SmsIcon = () => (
  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center shadow-md" style={{ boxShadow: "0 2px 0 hsl(142 76% 30%)" }}>
    <Phone className="w-4 h-4 text-white" />
  </div>
);

const MessengerIcon = () => (
  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 flex items-center justify-center shadow-md" style={{ boxShadow: "0 2px 0 hsl(280 70% 35%)" }}>
...
const WhatsAppIcon = () => (
  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center shadow-md" style={{ boxShadow: "0 2px 0 hsl(142 76% 28%)" }}>
    <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="currentColor">
...
const XTwitterIcon = () => (
  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-gray-800 to-black flex items-center justify-center shadow-md" style={{ boxShadow: "0 2px 0 hsl(0 0% 15%)" }}>
...
const EmailIcon = () => (
  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center shadow-md" style={{ boxShadow: "0 2px 0 hsl(0 70% 35%)" }}>
