...
function RoomCardGrid({ room, index, onJoin }: RoomCardGridProps) {
  ...
  return (
    <motion.div
      ...
      onClick={onJoin}
      className={`aspect-[2.2/1] md:aspect-[2.5/1] rounded-2xl overflow-hidden cursor-pointer transition-transform duration-200 hover:scale-[1.02] active:scale-[0.98] ${
        room.has_unread_activity ? "ring-2 ring-primary ring-offset-2" : ""
      }`}
      style={{
        boxShadow: "0 4px 0 0 hsl(var(--border)), 0 6px 20px -4px rgba(0,0,0,0.1)",
