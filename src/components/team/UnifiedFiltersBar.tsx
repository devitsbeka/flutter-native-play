              ...
              <DropdownMenuContent align="start" className="w-56 py-2">
                ...
                {filterOptions.map((option) => (
                  <DropdownMenuItem
                    ...
                    className={`py-3 text-[15px] ${filter === option.value ? "bg-primary/[0.18] text-primary font-bold focus:bg-primary/[0.18]" : ""}`}
                  >
                  ...
                  <>
                    ...
                    {sortOptions.map((option) => (
                      <DropdownMenuItem
                        ...
                        className={`py-3 text-[15px] ${sort === option.value ? "bg-primary/[0.18] text-primary font-bold focus:bg-primary/[0.18]" : ""}`}
                      >
                        <div className="flex items-center gap-2 w-full">
