  ...
  return (
    <div className="min-h-screen flex w-full">
      ...
      <main className="flex-1 min-h-screen relative pb-24 lg:pb-0">
        ...
        <div className="lg:hidden sticky top-0 z-20 backdrop-blur-md bg-background/80 relative">
          {/* Header Row */}
          ...
          {/* Fade-out gradient */}
          <div 
            className="absolute bottom-0 left-0 right-0 h-4 -mb-4 pointer-events-none"
            style={{
        ...
        <div className="relative z-10 flex flex-col overflow-x-hidden lg:max-w-[756px] xl:max-w-[630px] lg:mx-auto lg:border-x lg:border-border/40">
          {activeTab === "my-trivia" ? (
            <>
              {/* Friends Stories Bar */}
              <motion.div
