          ...
          <div id="team-main-content" className="flex-1 relative pb-24 lg:pb-0 bg-background">
            ...
            <div className="bg-background">
              <div className="px-4 pt-4 pb-2">
                ...
                <div className="w-full mx-auto px-4 pt-3 pb-2 overflow-hidden box-border" style={{ maxWidth: 'calc(100vw - 32px)' }}>
                      ...
                      {[
                        ...
                        { id: "my-content", label: "ჩემი ტრივია" },
                          ...
                          <button
                            ...
                            className={`relative flex-1 min-w-0 flex items-center justify-center gap-2 rounded-xl px-3 py-2.5 text-[15px] md:text-sm font-semibold transition-colors ${
                            activeTab === tab.id
                              ? "text-foreground"
