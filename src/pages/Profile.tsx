  ...
  return (
    <MainLayout showPlayButton={false}>
      <div className="min-h-full relative flex flex-col">
          {/* No page background video here.
              GlobalSplineBackground already paints this exact floating-blob
              loop for /profile, from App, in a `fixed inset-0` layer whose
              container has an OPAQUE #F9DBFF background at z-index 0. This
              page's own copy sat at -z-10 — underneath that — so it decoded a
              full-screen video every frame that no pixel of ever reached the
              screen. */}
          {/* Gradient Overlay */}
