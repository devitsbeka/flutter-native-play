...
export const ALL_HOOKS_FULL: HookDocFull[] = [
  ...
  { name: "useGameStake", path: "src/hooks/useGameStake.ts", description: "Manages betting/stake system for matches.", category: "Game", returns: ["canPlay", "hasEnoughCoins", "stakeAmount", "settleGame"], usedIn: ["Game", "CategoryQuizPage"] },
