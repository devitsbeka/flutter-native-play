...
const SWEPT = [
  ...
  "src/components/team/JoinRoomModal.tsx",
  "src/components/team/TVEnterCodeModal.tsx",
  ...
  "src/contexts/TVGameContext.tsx",
  "src/contexts/PendingChallengesContext.tsx",
  "src/hooks/useInAppPurchases.ts",
  "src/hooks/useFavorites.ts",
  "src/hooks/useProSeats.ts",
  "src/hooks/useGameRoom.ts",
  "src/hooks/useGameInvitations.ts",
  "src/hooks/useProPurchase.ts",
  "src/hooks/useDailyVipRewards.ts",
  "src/hooks/useVipBenefitsAutoGrant.ts",
  "src/hooks/useTriviaDrafts.ts",
