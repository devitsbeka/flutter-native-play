 ...
 * the constraint) — the database refuses ids it does not know.
 *
 * Retiring one is the same list in reverse, and the migration has to clear
 * the players who had picked it before it can tighten the CHECK: a
 * constraint is validated against the rows already there.
 */
