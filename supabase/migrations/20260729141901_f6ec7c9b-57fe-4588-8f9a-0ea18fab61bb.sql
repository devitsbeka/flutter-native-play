...
GRANT SELECT ON public.tv_score_events TO anon, authenticated;
GRANT ALL ON public.tv_score_events TO service_role;
GRANT USAGE, SELECT ON SEQUENCE public.tv_score_events_id_seq TO anon, authenticated, service_role;
