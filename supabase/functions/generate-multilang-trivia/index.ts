...
- iconKeywords: array of 2-3 English keywords for finding an icon (e.g., ["mountain", "nature", "landscape"])`;
    ...
    const userPrompt = `Generate ${count} unique trivia questions in ${languageName} about the category "${categoryName}".
...
Return ONLY valid JSON with this structure:
{
  "questions": [
    ...
    console.log(`Generating ${count} questions in ${language} for category ${categoryName}`);
