...
| Whole-product briefing | `docs/knowledge/` — seven documents covering the product, code, backend, economy, release and rules, written to be uploaded into an AI assistant's project knowledge |
